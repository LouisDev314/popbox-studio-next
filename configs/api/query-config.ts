...
const QueryConfigs = {
  ...
  fetchAdminFeaturedOrder: async (): Promise<AxiosResponse<IBaseApiResponse<IAdminFeaturedOrderResponse>>> => {
    return httpClient.get('/api/v1/admin/collections/featured/order', await withAdminAuth());
  },
