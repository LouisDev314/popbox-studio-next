  ...
  return (
    <div className="max-w-xl py-12">
      ...
      <p className="mt-3 text-sm leading-6 text-muted-foreground">
        {type === 'conflict' ? 'Your sign-in is secure, but we could not safely connect it to an existing customer record.' : 'We could not load your account right now. Your storefront data and cart are unchanged.'}
      </p>
