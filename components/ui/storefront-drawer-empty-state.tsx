...
export function StorefrontDrawerEmptyState(props: IStorefrontDrawerEmptyStateProps) {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-8rem)] flex-col items-center justify-center rounded-4xl border border-dashed border-border/70 bg-card px-8 py-14 text-center sm:py-16">
