    ...
    <div className="container mx-auto w-full px-4 py-8 sm:px-6 lg:px-8">
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <div className="h-10 w-64 max-w-full animate-pulse rounded-full bg-muted/40 sm:w-80" />
          <div className="h-5 w-full max-w-2xl animate-pulse rounded-full bg-muted/35" />
        </div>
